...
#         plt.text(-3.5, position, label, fontsize=14, rotation=90, va='center', ha='right')
#
...
#     plt.tight_layout()
#     plt.savefig('result_fig/JCGA_factory_result_fig/gantt.png', bbox_inches='tight')
#     # plt.show()
#
#     return ans
...
def run_experiment_for_dataset(dataset_path: str, dataset_name: str, result_subdir: str) -> None:
    ...
    result_dir = os.path.join('JCGA_result3', result_subdir)
...
if __name__ == '__main__':
    ...
    DATASET_TYPE = 'randomDataset/small/SET5'
